...
CONFIG = {
    ...
    # loader Walsh
    "ER": 1.0,
    "MAX_TERMS":  None,            # None -> tenta todos os j=1,...,2^n-1
...
def objective_for_single_j(
    ...
    # Hamiltoniano do MaxCut: minimizar loss = - <H_cut>
...
def run_sequential_walsh_maxcut(cfg: Dict[str, object]) -> Dict[str, object]:
    ...
    if max_terms is None:
        candidate_js = list(range(1, 2**n))
    else:
        candidate_js = list(range(1, min(2**n, int(max_terms) + 1)))
